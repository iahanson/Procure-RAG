...
class ChatApproach(Approach, ABC):
    ...
    NO_RESPONSE = "That information is not found in my knowledge base, please ask the question in another way (look for the link on the home page for advice on prompts)."
